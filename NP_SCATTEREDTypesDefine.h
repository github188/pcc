// NP_SCATTEREDTypesDefine.h
//
// 注意: 此文件为工具生成，请不要修改

#ifndef _NP_SCATTEREDTypesDefine_h_
#define _NP_SCATTEREDTypesDefine_h_
...
class NP_SCATTEREDSessionMaker;
...
#ifndef PCC_ModuleVersion_defined
#define PCC_ModuleVersion_defined
#pragma pack(push, 1)
struct PCC_ModuleVersion
{
	INT32 major;
	INT32 minor;
	INT32 built;
	...
	int Compare(const PCC_ModuleVersion& r) const;
	ISCM_STRUCT_COMPARE_OPERATORS(PCC_ModuleVersion)
};
#pragma pack(pop) // #pragma pack(push, 1)
#endif	// #ifndef PCC_ModuleVersion_defined

#ifndef PCC_ModuleTag_defined
#define PCC_ModuleTag_defined
struct PCC_ModuleTag
{
	tcps_String name;
	PCC_ModuleVersion version;

	int Compare(const PCC_ModuleTag& r) const;
	ISCM_STRUCT_COMPARE_OPERATORS(PCC_ModuleTag)
};
#endif	// #ifndef PCC_ModuleTag_defined
...
struct IPCC_Scatter_LocalMethod : public iscm_ILocalMethodBase, public PCC_Scatter_T
{
	typedef TCPSError (*FN_OnStreamedCall_L_)(
				IN void* sessionObj,
				IN const char* methodName,
	...
	typedef TCPSError (*FN_OnComputed)(
				IN void* sessionObj_wrap,
				IN INT64 taskKey,
...
typedef TCPSError (*FNMakeLocalSession_PCC_Scatter)(
			IN const IPP& clientID_IPP,
			IN NP_SCATTEREDSessionMaker& sessionMaker,
			OUT IPCC_Scatter_LocalMethod*& methodHandler,
			IN IPCC_Scatter_LocalCallback* callbackHandler
			);
#endif	// #ifndef PCC_Scatter_T_defined

// 'class PCC_Service_T'用于定义接口'PCC_Service'的局部类型
#ifndef PCC_Service_T_defined
#define PCC_Service_T_defined
class PCC_Service_T
{
public:
	#pragma pack(push, 1)
...
struct IPCC_Service_LocalMethod : public iscm_ILocalMethodBase, public PCC_Service_T
{
	typedef TCPSError (*FN_OnStreamedCall_L_)(
				IN void* sessionObj,
				IN const char* methodName,
	...
	typedef TCPSError (*FN_GetModuleFile)(
				IN void* sessionObj_wrap,
				IN INT64 moduleKey,
				IN INT32 fileType,
...
struct IPCC_Service_LocalCallback : public iscm_ILocalCallbackBase, public PCC_Service_T
{
	typedef TCPSError (*FN_OnStreamedCallback_L_)(
				IN void* sessionObj,
				IN const char* callbackName,
...
typedef TCPSError (*FNMakeLocalSession_PCC_Service)(
			IN const IPP& clientID_IPP,
			IN NP_SCATTEREDSessionMaker& sessionMaker,
...
#define PCC_Toolkit_T_defined
class PCC_Toolkit_T
{
};

struct IPCC_Toolkit_LocalMethod : public iscm_ILocalMethodBase, public PCC_Toolkit_T
{
	typedef TCPSError (*FN_OnStreamedCall_L_)(
				IN void* sessionObj,
				IN const char* methodName,
...
struct IPCC_Toolkit_LocalCallback : public iscm_ILocalCallbackBase, public PCC_Toolkit_T
{
	typedef TCPSError (*FN_OnStreamedCallback_L_)(
				IN void* sessionObj,
				IN const char* callbackName,
...
// 结构体的Compare()函数内联实现
	...
	inline int PCC_ModuleVersion::Compare(const PCC_ModuleVersion& r) const
	{
		int cmp = 0;
...
#endif	// #ifndef PCC_ModuleVersion_Compare_defined

#ifndef PCC_ModuleTag_Compare_defined
	#define PCC_ModuleTag_Compare_defined
	inline int PCC_ModuleTag::Compare(const PCC_ModuleTag& r) const
	{
		int cmp = 0;
		cmp = SimpleTypeCompare_(this->name, r.name);
		if(0 != cmp)
...
#endif	// #ifndef PCC_ModuleTag_Compare_defined
...
// 结构体的流式支持内联函数
	...
	inline int iscm_GetStreamedSize(const PCC_ModuleTag& val)
	{
		int size = 0;
		size += iscm_GetStreamedSize(val.name);
		size += (int)sizeof(val.version);
	...
	inline void iscm_StreamedLoad(PCC_ModuleTag& val, const BYTE*& data)
	{
		iscm_StreamedLoad(val.name, data);
		iscm_StreamedLoad(val.version, data);
	}
	inline void iscm_StreamedStore(BYTE*& buf, const PCC_ModuleTag& val)
	{
		iscm_StreamedStore(buf, val.name);
		iscm_StreamedStore(buf, val.version);
	}
#endif	// #ifndef PCC_ModuleTag_STREAMED_FUNCTIONS_defined
...
#endif	// #ifndef _NP_SCATTEREDTypesDefine_h_
